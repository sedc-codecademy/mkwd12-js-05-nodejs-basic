...
export default class OrderService {
	...
	static async createOrder(body, userId) {
		...
		const order = {
			...body,
			userId, // We add the userId to the order, this is the user that created the order (logged in user).
			id: uuidv4(),
		...
		// We return the order to the controller. The controller will send the response to the client.
		return order;
	}
