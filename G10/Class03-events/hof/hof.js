...
const mixedNumbers = [5, -3, 12, -8, 9, -4, 7, -1, 20, -15, 6, -10, 18, -2, 11, -13];

const users = [
    { id: 1, name: 'Alice', age: 28, occupation: 'Software Engineer', gender: 'female'},
    { id: 2, name: 'Bob', age: 35, occupation: 'Data Scientist', gender: 'male' },
    { id: 3, name: 'Charlie', age: 22, occupation: 'Graphic Designer', gender: 'male' },
    { id: 4, name: 'David', age: 42, occupation: 'Marketing Manager', gender: 'male' },
    { id: 5, name: 'Eva', age: 31, occupation: 'Product Manager', gender: 'female' },
];
...
const seniorUsers = users.map(user => {
    return { id: user.id, name: user.name, age: user.age, occupation: 'Senior ' + user.occupation };
});
...
const numbersToSort = [5, -3, 12, -8, 9, -4, 7, -1, 20, -15, 6, -10, 18, -2, 11, -13];
...
// - does not modify the original array
const areThereProgrammers = users.some(user => user.occupation.toLowerCase() === 'software engineer');
