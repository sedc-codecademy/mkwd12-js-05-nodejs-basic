...
export const getAllTasks = async filters => {
  ...
  // filters?.author - if filters is undefined it doesn't try to access author because it will throw an error
  // instead it simply returns undefined without error
  if (filters?.author) {
